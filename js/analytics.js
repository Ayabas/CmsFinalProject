(function() {
    ...
    var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/, pc = function(a) {
        ...
        if (d && a.get(cc) && (b = M[B][h])) {
            ...
            ea(b[c], "utm_content") || ea(b[c], "gclid") || ea(b[c], "dclid") || ea(b[c], "gclsrc")
                ) && d[p](b[c]);
    ...
    Z.da = function(a) {
        ...
        if (!K(Z.k.get(b))&&!Z.Z.get(b) && (Z.ca[ra](b) && J(Z.ca[b]), a = a.X, !a && Z.ca[ra](b) ? (J(39), a = b + ".js") : J(43), a)
            ...
            if (c = "https:" == c || c == d?!0 : "http:" != c?!1 : "http:" == d)
                c = tc(M[B][Ab]), a.G || 0 <= a.url[t]("?") || 0 <= a.path[t]("://") ? c=!1 : a[x] == c[x] && a[ja] == c[ja] ? c=!0 : (c = "http:" == a[E] ? 80 : 443, c = "www.google-analytics.com" == a[x] && (a[ja] || c) == c && ea(a.path, "/plugins/")?!0 : !1);
            ...
            if (a.u)
                ...
                if (a.A)
                    ...
                    if (a.i) {
                        ...
                        a.e && (b = b[Z.H].get(a.e)), b[a.d][G](b, a.a)
            }
        } catch (c) {}
    };
    function tc(a) {
